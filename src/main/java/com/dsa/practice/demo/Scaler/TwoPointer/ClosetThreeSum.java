...
public class ClosetThreeSum {
    ...
    public static void main(String[] args) {
        System.out.println(new ClosetThreeSum().findClosestThreeSum(new int[]{2,1,-9,-7,-8,2,-8,2,3,-8},-1));
        System.out.println("============================");
        System.out.println(new ClosetThreeSum().findClosestThreeSum(new int[]{5,-2,-1,-10,10},5));
    }
}
//[-10,-2,-1,5,10]